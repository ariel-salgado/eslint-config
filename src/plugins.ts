...
export { default as plugin_perfectionist } from 'eslint-plugin-perfectionist';
export { configs as plugin_regexp } from 'eslint-plugin-regexp';
export { default as plugin_unicorn } from 'eslint-plugin-unicorn';
export { default as plugin_unused_imports } from 'eslint-plugin-unused-imports';
